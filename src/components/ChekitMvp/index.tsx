...
import { ImageContents, Intro, MainDesc, MainImageBox, SubDesc } from '@components/IntroContent/style';
        ...
        <div className="description">
          <MainDesc>
            <span>
              ...
              <br />
              회사의 메인 프로덕트의 전환을 최대한 빠르게 가져가기 위해 구현 기능은 최소화하고, 해당 서비스가 시장에서
              경쟁력이 있는지 검증한 프로젝트였습니다. 최소한의 구현으로 시작한 해당 프로젝트가 시장에서 꽤나 호응을
              얻어, 이후 버전 2를 기획하게 되었고, 현재 회사의 메인 프로덕트 입니다.
            </span>
            <br />
          </MainDesc>
          <SubDesc>
