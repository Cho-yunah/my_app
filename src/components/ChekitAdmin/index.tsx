...
import { ImageContents, MainDesc, MainImageBox, SubDesc, Intro } from '@components/IntroContent/style';
        ...
        <div className="description">
          <MainDesc>
            <span>
              ...
              기존에 사용하던 어드민이 서비스 별로 분리되어 있어서 서비스 별로 데이터를 확인하기 어렵고, 관리의 효율성이
              떨어지는 문제점이 있었습니다. 이를 해결하기 위해 여러개로 나눠져있던 어드민들을 하나로 통합하고, 관리자가
              원하는 정보를 빠르게 확인할 수 있도록 UI/UX를 개선하였습니다. 또 관리자의 필요를 반영하여 원하는 정보를
              빠르게 확인할 수 있도록 필터링 기능과 검색 기능, 쿠폰 발급, 고객 관리 등의 기능을 추가였습니다.
            </span>
            <br />
          </MainDesc>
          <SubDesc>
