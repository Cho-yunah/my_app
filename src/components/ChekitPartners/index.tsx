      ...
      <div className="description">
        <MainDesc>
          <span>
            ...
            체킷의 제품을 사용한 후, 자신의 닉네임 코드를 만들어 체킷의 서비스를 SNS에 홍보 및 추천하면, 이를 통해
            수익을 창출할 수 있는 프로그램입니다. 3주간의 짧은 기간에 해야했던 프로젝트였는데, 소비자가 보는 사이트와
            더불어 해당 웹을 관리하는 어드민 페이지까지 완성도 있게 만들어졌고, 모바일 화면까지 반응형으로
            만들어졌습니다. 약 200명의 파트너스 회원들이 활동을 하고 있고, 이를 통해 체킷 서비스의 마케팅 효과를 높이고
            있습니다.
          </span>
          <br />
        </MainDesc>
        <SubDesc>
          <li>React, Recoil, React-Hook-Form</li>
          <li>Team Project</li>
        </SubDesc>
      </div>
      <MainImageBox>
        <img
          style={{ boxShadow: '0 2px 5px 1px rgba(0, 0, 0, 0.12)', aspectRatio: 5 / 3 }}
          src={imageUrl}
          alt="파트너스 이미지"
        />
      </MainImageBox>
